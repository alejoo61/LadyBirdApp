// app/equipment/[code]/EquipmentQRClient.tsx
'use client';
...
export default function EquipmentQRClient() {
        ...
        {mode === 'transfer' && (
          <div className="bg-white rounded-xl p-5 shadow-sm space-y-4">
            ...
            <div className="flex items-center gap-3">
              <input type="checkbox" id="temporary" checked={isTemporary} onChange={e => setIsTemporary(e.target.checked)} className="w-4 h-4 rounded text-red-600" />
