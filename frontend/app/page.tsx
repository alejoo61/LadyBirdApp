...
import { LayoutDashboard, Store, HardDrive, Wrench, UtensilsCrossed, LogOut } from 'lucide-react';
        ...
        <main className="flex-1 overflow-y-auto p-10 bg-bone">
          ...
          {(activeTab === 'Dashboard' || activeTab === 'Maintenance') && (
            <div className="bg-white p-10 rounded-[3rem] shadow-sm border border-tumbleweed">
              <h2 className="text-3xl font-black text-night uppercase italic tracking-tighter mb-4">
                {activeTab}
              </h2>
